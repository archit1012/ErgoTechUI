...
const AnalysisGraph = () => {
  ...
  useEffect(() => {
    ...
    const chart1 = new Chart(ctx1, {
      type: 'line',
      data: {
        labels: ['2017-01-02', '2017-04-02', '2017-07-02', '2018-01-02', '2018-07-02', '2019-01-02', '2018-07-02'],
        datasets: [
          {
          ...
          },
          {
            ...
            pointHoverBackgroundColor: tailwindConfig().theme.colors.indigo[600],
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 h-72">
      <header className="px-4 py-2 border-b border-slate-100 dark:border-slate-700">
        <h2 className="font-semibold text-slate-800 dark:text-slate-100">Analysis Graph</h2>
      </header>
      <div className="p-4 relative h-64 w-auto">
