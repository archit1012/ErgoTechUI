...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      />
      <label
        className="flex items-center justify-center cursor-pointer w-6 h-6 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full"
        htmlFor="light-switch"
      >
        <svg className="w-4 h-4 dark:hidden" width="13" height="13" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <svg className="w-4 h-4 hidden dark:block" width="13" height="13" xmlns="http://www.w3.org/2000/svg">
          <path
            className="fill-current text-slate-400"
